...
<div id="gs-admin-settings-page">
    ...
    <a href="http://www.gosquared.com/" title="Go to the GoSquared homepage" target="_blank">
        <div id="gosquaredlogo"></div>
    </a>
    ...
    <div class="gs-admin-header">
        ...
        ?>
        <p>
            Go to you <a href='<?php echo site_url(); ?>/wp-admin/widgets.php'>Wordpress Widget settings</a> to enable
            GoSquared widgets.
        </p>
        ...
        <a href='<?php echo site_url(); ?>/wp-admin/widgets.php'><img
    ...
    <form name="gs-options" action="" method="post">
        ...
        <p>Your Site Token enables GoSquared to monitor your Wordpress site's traffic. <a
            href="https://www.gosquared.com/join/"
            title="Sign up to GoSquared for free to start monitoring your site in real-time" target="_blank">Sign up for
            free</a> to register your site with GoSquared.</p>
        ...
        <table class="gs-settings">
            ...
            <tr>
                ...
                <td><input type="radio" name="gs_trackPreview" value="Yes"
                           id="trackPreview" <?php if ($trackPreview == 'Yes')
                        echo 'checked="checked" '; ?>/> Yes
                </td>
                <td><input type="radio" name="gs_trackPreview" value="No"
                           id="trackPreview" <?php if ($trackPreview == 'No')
                        echo 'checked="checked" '; ?>/> No
                </td>
            </tr>
            <tr>
                ...
                <td><input type="radio" name="gs_trackUser" value="UserID"
                           id="trackUser" <?php if ($trackUser == 'UserID')
                        echo 'checked="checked" '; ?>/> User ID
                </td>
                <td><input type="radio" name="gs_trackUser" value="Username"
                           id="trackUser" <?php if ($trackUser == 'Username')
                        echo 'checked="checked" '; ?> /> Username
                </td>
                <td class="wide"><input type="radio" name="gs_trackUser" value="DisplayName"
                                        id="trackUser" <?php if ($trackUser == 'DisplayName')
                        echo 'checked="checked" '; ?>/> Display Name
                </td>
            </tr>
            <tr>
...
function gs_print_gstc()
{
    ...
    if ($acct) {
        ...
        define('GS_PLUGIN_DIR', basename(dirname(__FILE__)));
        $script_url = WP_PLUGIN_URL . "/" . GS_PLUGIN_DIR . "/tracker.js";
        wp_enqueue_script('gstc', $script_url, '', false, true);
